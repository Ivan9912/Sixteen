                ...
                props.map((categorias, i) => {
                    return (
                        categorias.name == 'Catálogo' ?
                            ...
                            :
                            (<li key={`$ID-${i}`} className='border border-transparent box-border hover:border hover:border-zinc-300 hover:rounded [&>a]:hover:text-pink-500 hover:bg-slate-100 hover:shadow-xl active:shadow-2xl'>
